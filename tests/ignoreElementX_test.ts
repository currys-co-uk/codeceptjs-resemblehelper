...
Scenario('in seeVisualDiff(): {ignoredElement: "[href*="/dropdown"]"}', async ({ I }) => {
  ...
  I.assertStringIncludes(messageOutput, 'Browser screen was scrolled "0" px vertically and "0" px horizontal.');
});

Scenario('in seeVisualDiff(): { ignoredElements: ["#hot-spot", "#page-footer"] }', async ({ I }) => {
  I.say('element counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
...
Scenario('in seeVisualDiff(): "{ ignoredQueryElementAll: "p" }"', async ({ I }) => {
  ...
  const messageOutput = debugCatcher.messages;
  I.assertStringIncludes(messageOutput, 'Element: "p" has coordinates: {"left":61,"top":87.890625,"right":1031,"bottom":112.890625}');
  I.assertStringIncludes(messageOutput, 'Element: "p" has coordinates: {"left":61,"top":132.890625,"right":1031,"bottom":157.890625}');
  I.assertStringIncludes(messageOutput, 'Browser screen was scrolled "0" px vertically and "0" px horizontal.');
});

Scenario('in seeVisualDiff(): "{ ignoredElement: { shadow: ["my-paragraph"] } }"', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
...
Scenario('in seeVisualDiff(): { ignoredElements: [{ shadow: ["my-paragraph"] }, { shadow: ["my-paragraph", "slot"] }] }', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
  ...
  await I.seeVisualDiff('ignoredElements_shadow_seeVisualDiff.png', {
    ignoredElements: [{ shadow: ['my-paragraph'] }, { shadow: ['my-paragraph', 'slot'] }],
  });
  const messageOutput = debugCatcher.messages;
  I.assertStringIncludes(
    messageOutput,
...
Scenario('in seeVisualDiff(): { ignoredQueryElementAll: { shadow: ["my-paragraph"] }', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
...
Scenario('in seeVisualDiffForElement(): { ignoredElement: "#hot-spot" }', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
  ...
  I.assertStringIncludes(messageOutput, 'Browser screen was scrolled "0" px vertically and "0" px horizontal.');
  I.assertStringIncludes(messageOutput, 'Area for selector #content {"left":46,"top":32,"right":1046,"bottom":360}');
  I.assertStringIncludes(messageOutput, 'You ignore one element in screenshotted element "#content" ...');
  I.assertStringIncludes(
    messageOutput,
...
Scenario('in seeVisualDiffForElement(): { ignoredElements: [".large-2", "div.row:nth-of-type(3)"] }', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
  ...
  await I.seeVisualDiffForElement('div.example', 'ignoredElements_seeVisualDiffForElement.png', {
  ...
  I.assertStringIncludes(messageOutput, 'Browser screen was scrolled "0" px vertically and "0" px horizontal.');
  I.assertStringIncludes(messageOutput, 'Area for selector div.example {"left":61,"top":37.390625,"right":1031,"bottom":574.390625}');
  I.assertStringIncludes(messageOutput, 'You ignore more elements in screenshotted element "div.example" ...');
  I.assertStringIncludes(
    messageOutput,
...
Scenario('in seeVisualDiffForElement(): { ignoredQueryElementAll: ".large-2" }', async ({ I }) => {
  I.say('elements counted coordinates are correct');
  const debugCatcher = new DebugCatcher();
...
Scenario('seeVisualDiffForElement() with scrolled page 222px vertically', async ({ I }) => {
  ...
  const messageOutput = debugCatcher.messages;
  I.assertStringIncludes(messageOutput, 'Browser screen was scrolled "222" px vertically and "0" px horizontal.');
  I.assertStringIncludes(messageOutput, 'Screenshotted element was in test scrolled "222" px vertically and "0" px horizontal.');
  I.assertStringIncludes(
    messageOutput,
    'Element coordinates were recounted to element screenshotted size as: {"left":15,"top":415.296875,"right":88,"bottom":432.296875}',
  );
});
